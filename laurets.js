    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Berlin University", city: "Berlin", country: "Germany" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their discovery of the laws governing the impact of an electron upon an atom"',
        affiliations: [
          { name: "Halle University", city: "Halle", country: "Germany" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Calcutta University", city: "Calcutta", country: "India" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Leipzig University", city: "Leipzig", country: "Germany" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Rome University", city: "Rome", country: "Italy" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Columbia University", city: "New York, NY", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their pioneer work on the transmutation of atomic nuclei by artificially accelerated atomic particles"',
        affiliations: [
          { name: "Trinity College", city: "Dublin", country: "Ireland" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Stanford University", city: "Stanford, CA", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Technical University", city: "Munich", country: "Germany" },
          {
            name: "California Institute of Technology (Caltech)",
            city: "Pasadena, CA",
            country: "USA",
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Bell Laboratories", city: "Holmdel, NJ", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "CERN", city: "Geneva", country: "Switzerland" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Coll\u00e8ge de France", city: "Paris", country: "France" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Nancy University", city: "Nancy", country: "France" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Toulouse University", city: "Toulouse", country: "France" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Graz University", city: "Graz", country: "Austria" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Institut du Radium", city: "Paris", country: "France" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their discovery and development of the diene synthesis"',
        affiliations: [
          { name: "Cologne University", city: "Cologne", country: "Germany" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their discoveries in the field of the chemistry and technology of high polymers"',
        affiliations: [
          { name: "Institute of Technology", city: "Milan", country: "Italy" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Yale University", city: "New Haven, CT", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their contributions to the development of the concept of conformation and its application in chemistry"',
        affiliations: [
          { name: "University of Oslo", city: "Oslo", country: "Norway" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          ...
          { name: "University of Texas", city: "Austin, TX", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their development and use of molecules with structure-specific interactions of high selectivity"',
        affiliations: [
          { name: "Du Pont", city: "Wilmington, DE", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Aarhus University", city: "Aarhus", country: "Denmark" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Marburg University", city: "Marburg", country: "Germany" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Pavia University", city: "Pavia", country: "Italy" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"in recognition of their work on the structure of the nervous system"',
        affiliations: [
          { name: "Madrid University", city: "Madrid", country: "Spain" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Institut Pasteur", city: "Paris", country: "France" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Berne University", city: "Bern", country: "Switzerland" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Vienna University", city: "Vienna", country: "Austria" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Brussels University", city: "Brussels", country: "Belgium" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Institut Pasteur", city: "Tunis", country: "Tunisia" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Szeged University", city: "Szeged", country: "Hungary" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Ghent University", city: "Ghent", country: "Belgium" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Munster University", city: "Munster", country: "Germany" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "University of Lisbon", city: "Lisbon", country: "Portugal" },
          {
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Mayo Clinic", city: "Rochester, MN", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their discoveries relating to the hormones of the adrenal cortex, their structure and biological effects"',
        affiliations: [
          { name: "Basel University", city: "Basel", country: "Switzerland" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "The Salk Institute", city: "San Diego, CA", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Tufts University", city: "Medford, MA", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "New England Biolabs", city: "Beverly, MA", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "Texas Instruments", city: "Dallas, TX", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for the discovery and development of conductive polymers"',
        affiliations: [
          { name: "University of Tsukuba", city: "Tokyo", country: "Japan" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their work on chirally catalysed hydrogenation reactions"',
        affiliations: [
          { name: "Nagoya University", city: "Nagoya", country: "Japan" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their development of soft desorption ionisation methods for mass spectrometric analyses of biological macromolecules"',
        affiliations: [
          { name: "Shimadzu Corp.", city: "Kyoto", country: "Japan" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for the discovery of the origin of the broken symmetry which predicts the existence of at least three families of quarks in nature"',
        affiliations: [
          { name: "Kyoto Sangyo University", city: "Kyoto", country: "Japan" },
          {
    ...
    prizes: [
      {
        ...
        affiliations: [{ name: "University of Delaware", country: "USA" }],
      },
    ],
  },
  {
    ...
    prizes: [
      {
        ...
        motivation:
          '"for palladium-catalyzed cross couplings in organic synthesis"',
        affiliations: [
          { name: "Hokkaido University", city: "Sapporo", country: "Japan" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their discoveries concerning a novel therapy against infections caused by roundworm parasites"',
        affiliations: [
          { name: "Kitasato University", city: "Tokyo", country: "Japan" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "University of Tokyo", city: "Kashiwa", country: "Japan" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "University of Maine", city: "Maine, ME", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their discoveries of molecular mechanisms controlling the circadian rhythm"',
        affiliations: [
          { name: "Brandeis University", city: "Waltham, MA", country: "USA" },
          { name: "Howard Hughes Medical Institute" },
        ],
      },
    ],
    ...
    prizes: [
      {
        ...
        affiliations: [
          { name: "University of Missouri", city: "Columbia", country: "USA" },
        ],
      },
    ],
  },
    ...
    prizes: [
      {
        ...
        motivation:
          '"for their discoveries of receptors for temperature and touch"',
        affiliations: [
          { name: "Scripps Research", city: "La Jolla, CA", country: "USA" },
          { name: "Howard Hughes Medical Institute" },
        ],
      },
    ],
